...
<div id="featuredGames" class="carousel slide mt-3" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo $baseUrl; ?>/images/68bdd97e5b444.jpg" class="d-block w-100 carousel-img" alt="God of War">
        ...
        <div class="carousel-item">
            <img src="<?php echo $baseUrl; ?>/images/693bf966cb8da.webp" class="d-block w-100 carousel-img" alt="Elden Ring">
            <div class="carousel-caption d-none d-md-block">
                <h5>Elden Ring</h5>
        ...
        <div class="col">
            <a href="<?php echo $baseUrl; ?>/game/<?php echo (int)$game['id']; ?>" class="text-decoration-none">
                <div class="card h-100 game-card">
                    <img src="<?php echo $baseUrl; ?><?php echo htmlspecialchars($game['cover_image']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($game['title']); ?>">
                    <div class="card-body">
