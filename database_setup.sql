...
CREATE TABLE ratings (
    ...
    game_id INT NOT NULL,
    user_id INT NOT NULL,
    fun TINYINT NOT NULL DEFAULT 1,
    graphics TINYINT NOT NULL DEFAULT 1,
    audio TINYINT NOT NULL DEFAULT 1,
    story TINYINT NOT NULL DEFAULT 1,
    ux_ui TINYINT NOT NULL DEFAULT 1,
    technical TINYINT NOT NULL DEFAULT 1,
...
ALTER TABLE ratings
ADD CONSTRAINT chk_fun CHECK (fun BETWEEN 1 AND 5),
ADD CONSTRAINT chk_graphics CHECK (graphics BETWEEN 1 AND 5),
ADD CONSTRAINT chk_audio CHECK (audio BETWEEN 1 AND 5),
ADD CONSTRAINT chk_story CHECK (story BETWEEN 1 AND 5),
ADD CONSTRAINT chk_ux_ui CHECK (ux_ui BETWEEN 1 AND 5),
ADD CONSTRAINT chk_technical CHECK (technical BETWEEN 1 AND 5),
...
-- review_votes table already defined above
