...
// public function voteComment(int $reviewId, int $userId, string $voteType): array {
//     // voteType: 'up' or 'down'
...
//         } else {
//             // Change vote
//             $this->updateVote($reviewId, $userId, $voteType);
//             return ['success' => true, 'action' => 'changed'];
//         }
//     }

//     // New vote
//     $this->addVote($reviewId, $userId, $voteType);
//     return ['success' => true, 'action' => 'added'];
// }
...
// private function updateVote(int $reviewId, int $userId, string $voteType): void {
//     $stmt = $this->db->prepare(
...
// private function removeVote(int $reviewId, int $userId): void {
//     $stmt = $this->db->prepare(
...
// private function updateVoteCounts(int $reviewId): void {
//     $stmt = $this->db->prepare(
//         "SELECT
//             SUM(CASE WHEN vote_type = 'up' THEN 1 ELSE 0 END) AS upvotes,
//             SUM(CASE WHEN vote_type = 'down' THEN 1 ELSE 0 END) AS downvotes
...
//          WHERE id = ?"
//     );
//     $update->bind_param("iiii", $upvotes, $downvotes, $score, $reviewId);
//     $update->execute();
// }

// public function getUserVoteOnComment(int $reviewId, int $userId): ?string {
//     $stmt = $this->db->prepare(
//         "SELECT vote_type 
//          FROM comment_votes 
//          WHERE comment_id = ? AND user_id = ?"
